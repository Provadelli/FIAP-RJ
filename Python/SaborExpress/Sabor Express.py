...
def cadastrar_novo_restaurante():
    ...
    Outputs:
    - Adiciona um novo restaurante à lista de restaurantes, com o estado "desativado" por padrão.
    '''
...
def listar_restaurantes():
    ...
    Outputs:
    - Exibe uma tabela com o nome do restaurante, categoria e status (ativado ou desativado).
    '''
...
def alternar_estado_restaurante():
    ...
    - Nome do restaurante
    Outputs:
    - Alterna o estado do restaurante entre ativado e desativado.
    '''
